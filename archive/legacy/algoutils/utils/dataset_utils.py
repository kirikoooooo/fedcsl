...
def LoadDataset_HAR(numClient,dirchlet_alpha=0.1):
    ...
    # print(y_fed[1])
    # print(y_fed[2])
    return X_all, y_all, X_test, y_test, X_fed, y_fed
    
    
def LoadDataset_UEA(dataset, numClient,dirchlet_alpha=0.1):
    # 加载UEA数据集
    # UEA 数据集测试   
    # N x D x T
    if dataset == "":
